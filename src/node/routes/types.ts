...
export const MailType = Type.Literal("mail")
...
export const QueryStringType = Type.Union([FilesQueryStringType, ChatsQueryStringType, MailboxIncomingMessageQueryStringType])
